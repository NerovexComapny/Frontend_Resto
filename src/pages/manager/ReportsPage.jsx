...
const ReportsPage = () => {
  ...
  const renderDaily = () => (
    <Motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-6">
      <div className="flex items-center justify-between bg-[#132845] border border-[#1e3a5f] p-4 rounded-2xl">
        ...
        <input 
          ...
          className="bg-[#0d1f3c] border border-[#1e3a5f] rounded-xl px-4 py-2 text-slate-200 outline-none focus:border-[#7c6af7] focus:ring-1 focus:ring-[#7c6af7] transition-colors"
        />
      </div>
            ...
            <tbody className="divide-y divide-[#1e3a5f]">
              {DAILY_ORDERS.map((order, i) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-slate-400">{order.table}</td>
                  <td className="px-6 py-4 font-semibold text-emerald-400">{order.amount.toFixed(2)} TND</td>
              ...
              <tbody className="divide-y divide-[#1e3a5f]">
                {TOP_ITEMS.map((item, i) => (
                  <tr key={i} className="hover:bg-[#0d1f3c]/50">
                    ...
                    <td className="px-6 py-4 text-slate-400">{item.qty}</td>
                    <td className="px-6 py-4 font-semibold text-emerald-400">{item.revenue.toFixed(2)} TND</td>
                  </tr>
                ))}
                {TOP_ITEMS.length === 0 && (
                  <tr>
  ...
  return (
    <ManagerLayout>
      <div className="space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className="flex items-center space-x-2 bg-[#7c6af7]/10 hover:bg-[#7c6af7]/20 text-[#7c6af7] border border-[#7c6af7]/20 px-4 py-2.5 rounded-xl font-semibold transition-colors disabled:opacity-60"
            >
            ...
            <button
              ...
              className="flex items-center space-x-2 bg-[#7c6af7] hover:bg-[#6557e0] text-[#0d1f3c] px-4 py-2.5 rounded-xl font-semibold transition-colors disabled:opacity-60"
            >
        ...
        {/* Tabs */}
        <div className="flex space-x-2 bg-[#132845] p-1.5 rounded-xl w-fit border border-[#1e3a5f]">
